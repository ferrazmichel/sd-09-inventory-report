...
class SimpleReport:
    ...
    def generate(cls, list_prod):
        order = FunctionsReports.order_date(list_prod)
        nearest = FunctionsReports.nearest_date(list_prod)
        company = max(FunctionsReports.companies(list_prod))
        return (
